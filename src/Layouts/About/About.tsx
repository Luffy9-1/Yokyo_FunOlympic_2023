        ...
        <div className="about__wrapper">
          ...
          <div className="about__right__section">
            <p>
              ...
              2023 an unforgettable experience. Our primary goal is to ensure
              the event is not only seamlessly organized but also highly
              enjoyable and accessible to all attendees, both locally and
              internationally.
            </p>
          </div>
        </div>
